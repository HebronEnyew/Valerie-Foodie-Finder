...
const MealDetails = () => {
  ...
  return (
    <div className="p-6 md:px-20 w-[80%] mx-auto bg-gray-50 min-h-screen">
      {query && (
        <div className="mb-6">
          <button
            onClick={() => navigate(-1)}
          ...
          {visibleCount < allResults.length && (
            <button
              onClick={() => {
                ...
                setMeals(allResults.slice(0, nextCount));
              }}
              className="mt-4 px-4 py-2 bg-orange-500 text-white rounded-3xl w-[25%] flex mx-auto items-center"
            >
              View More
            </button>
          )}
